...
JPG/PNG
  ...
  → human-in-the-loop safety gate: вид подтверждается только при confidence ≥ 70%
...
Пример размеченного исходного снимка:

![Пример детекции растений на DJI-снимке](case1/output/annotated/annotated_DJI_20260609122641_0177_D.JPG)
