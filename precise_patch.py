...
# 2. Coordinates constraint (just turn it into a pass block instead of deleting to avoid indent issues)
...
# 5. Rate constraint for spray_weed
...
# 8. ISO-XML Point Count Mismatch -> Missing GRD
